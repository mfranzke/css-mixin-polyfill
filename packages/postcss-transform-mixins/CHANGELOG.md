...
- [#139](https://github.com/mfranzke/css-mixin-polyfill/pull/139) [`2666f97`](https://github.com/mfranzke/css-mixin-polyfill/commit/2666f979827890a39dc944cd2adec63ee6891bf1) Thanks [@mfranzke](https://github.com/mfranzke)! - fix(PostCSS): warning about missing `from` option

## 0.1.7

### Patch Changes

- 0ba6c34: fix: support `async` PostCSS plugins in `postcss-transform-mixins`
